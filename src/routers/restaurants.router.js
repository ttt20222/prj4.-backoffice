...
// 업장 생성 라우트
router.post('/', requireAccessToken, createRestaurantValidator, restaurantController.createRestaurant); 
...
// 업장 삭제 라우트
router.delete('/:restaurantId', requireAccessToken, restaurantController.deleteRestaurant); 
